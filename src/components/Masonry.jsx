...
const Masonry = ({
    ...
    return items.map(child => {
      ...
      if (span >= 2) {
        ...
        const height = child.aspectRatio
          ...
          ? w * fixedAspectRatio
          : child.height / 2;
        const y = Math.max(...colHeights.slice(bestStart, bestStart + span));

        for (let c = bestStart; c < bestStart + span; c++) {
          colHeights[c] = y + height;
        }
  ...
  // Calculate total grid height for container sizing
